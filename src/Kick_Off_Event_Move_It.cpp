...
{
// DAS ALLES LEBENSNOTWENDIG - ANFANG: #PfotenWeg, #WeheDir, #IToldYouSo
...
// DAS ALLES LEBENSNOTWENDIG - ENDE
  ...
  getBlockFromPrinterToStorage(joint_model_group, &move_group, visual_tools, speed, text_pose, 1,
   current_state, &acg, &acs, &acm, goalG, goalS, goalM);


  getBlockFromStorageToOutput(joint_model_group, &move_group, visual_tools, speed, text_pose, 1,
   current_state, &acg, &acs, &acm, goalG, goalS, goalM);
